            ...
            <div class="row">
                ...
                <div class="panel panel-danger">
                    ...
                    <div class="panel-heading"><h4>1.1 (ทำทุก 1 สัปดาห์) </h4>
                        <?= Html::button('<i class="glyphicon glyphicon-repeat"></i> นำเข้าข้อมูลแพ้ยา', ['value' => Url::to(['default/opdallergy']), 'title' => 'ปรับข้อมูลยา', 'class' => 'showModalButton btn btn-success']); ?>
                    <?= Html::button('<i class="glyphicon glyphicon-repeat"></i> ปรับรายการยา', ['value' => Url::to(['default/drugnew']), 'title' => 'ปรับข้อมูลยา', 'class' => 'showModalButton btn btn-danger']); ?>
