...
/* @var $searchModel app\modules\pcu\models\MdrugitemsSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Mdrugitems';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="mdrugitems-index">
 ...
 <?=
    GridView::widget([
        ...
        'panel' => [
            'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-calendar"> นำเข้าข้อมูลยา คลิกที่ <span class="glyphicon glyphicon-pencil"></span>และบันทึก เพื่อนำเข้า</i>
               </h3>',
            'type' => GridView::TYPE_PRIMARY,
             'before' => Html::a('<i class="glyphicon glyphicon-refresh"></i> ประมวลผลรายการยา', ['/pcu/mdrugitems/up-process'], ['class' => 'btn btn-danger']),
            'after' => Html::a('<i class="glyphicon glyphicon-repeat"></i> โหลดข้อมูลใหม่', ['/pcu/mdrugitems/index'], ['class' => 'btn btn-info']),
             ...
             ['class' => 'yii\grid\ActionColumn',
                ...
                'buttons' => [
                    'view' => function ($url, $model) {
                        $t = 'index.php?r=pcu/mdrugitems/update&id=' . $model->icode;
