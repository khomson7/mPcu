...
<?php echo Alert::widget([
	...
	'body' => 'กรุณาตรวจสอบก่อนการนำเข้า'
]); ?>
...
<div class="mdrugitems-form">
    ...
    <?= $form->field($model, 'sks_specprep')->textInput(['maxlength' => true]) ?>
    ...
    <?= $form->field($model, 'dmi')->textInput(['maxlength' => true]) ?>
    ...
    <?= $form->field($model, 'no_remed')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'force_round_qty')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'atc_code')->textInput(['maxlength' => true]) ?>

    <?= $form->field($model, 'state_item_id')->textInput() ?>
