...
<div class="mlab-items-index">
    ...
    <?= GridView::widget([
        ...
        'panel' => [
            'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-calendar"> นำเข้าตาราง Lab คลิกที่ <span class="glyphicon glyphicon-pencil"></span>และบันทึก เพื่อนำเข้า</i>
               </h3>',
              ...
              ['class' => 'yii\grid\ActionColumn',
                ...
                'buttons' => [
                    'view' => function ($url, $model) {
                        $t = 'index.php?r=pcu/m-lab-items/updateimport&id=' . $model->lab_items_code;
