 ...
 * @property int $house_regist_type_id
 ...
 * @property int $income_per_year
 * @property int $home_position_id
 * @property int $family_position_id
 ...
 * @property int $father_person_id
 * @property int $mother_person_id
 * @property string $pttype_no
 * @property int $sps_person_id
 * @property string $birthtime
 * @property int $age_y
 * @property int $age_m
 * @property int $age_d
 * @property int $family_id
 * @property int $person_house_position_id
 * @property int $couple_person_id
 ...
 * @property int $person_discharge_id
 * @property string $movein_date
 * @property string $discharge_date
 * @property int $person_labor_type_id
 ...
 * @property int $ncd_dm_history_type_id
 * @property int $ncd_ht_history_type_id
 * @property int $agriculture_member_type_id
 * @property string $senile
 * @property string $in_region
 * @property double $body_weight_kg
 * @property double $height_cm
 * @property int $nutrition_level
 * @property int $height_nutrition_level
 * @property int $bw_ht_nutrition_level
 ...
 * @property int $person_dm_screen_status_id
 * @property int $person_ht_screen_status_id
 * @property int $person_stroke_screen_status_id
 * @property int $person_obesity_screen_status_id
 * @property int $person_dmht_manage_type_id
 * @property int $last_screen_dmht_bdg_year
 * @property string $dw_chronic_register
 * @property string $mobile_phone
 * @property string $kcheck
 */
