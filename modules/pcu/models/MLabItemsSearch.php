 ...
 */
class MLabItemsSearch extends MLabItems
{
    /**
     * {@inheritdoc}
     */
    ...
    public function search($params)
    {
        ...
        $model = LabItems::find()->select('lab_items_name')
                ->all();
        
        $query = MLabItems::find()
        
               // ->where('lab_items_name :lab_items_name',[':lab_items_name' => $model]);
            ->where(['NOT IN', 'lab_items_name', $model]);
        ...
        $query->andFilterWhere(['like', 'lab_items_name', $this->lab_items_name])
            ...
            ->andFilterWhere(['like', 'provis_labcode', $this->provis_labcode])
            ...
            ->andFilterWhere(['like', 'show_refer_doc', $this->show_refer_doc]);
