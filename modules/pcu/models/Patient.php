 ...
 * @property int $hospital_department_id
 * @property string $membercard_no
 * @property int $ec_relation_type_id
 * @property int $patient_color_id
 * @property int $number_of_relatives
 * @property int $birth_order
 * @property int $person_labor_type_id
 * @property string $is_card_destroy
 * @property string $card_destroy_date
 */
class Patient extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['hos_guid'], 'required'],
            [['birthday', 'deathday', 'firstday', 'last_update', 'birthtime', 'last_visit', 'reg_time', 'card_destroy_date'], 'safe'],
            ...
            [['marrystatus', 'sex', 'truebirthday', 'educate', 'family_status', 'labor_type', 'type_area', 'legal_action', 'node_id', 'admit', 'death', 'inregion', 'in_cups', 'destroyed', 'anonymous_person', 'is_card_destroy'], 'string', 'max' => 1],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'number_of_relatives' => 'Number Of Relatives',
            'birth_order' => 'Birth Order',
            'person_labor_type_id' => 'Person Labor Type ID',
            'is_card_destroy' => 'Is Card Destroy',
            'card_destroy_date' => 'Card Destroy Date',
        ];
    }
}
