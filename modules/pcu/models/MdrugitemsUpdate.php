...
/**
 * MdrugitemsSearch represents the model behind the search form of `app\modules\pcu\models\Mdrugitems`.
 */
class MdrugitemsUpdate extends Mdrugitems {
    ...
    public function search($params) {
        ...
        $model = Drugitems::find()->select(['concat(icode,tpu_code_list)'])
               // ->where('istatus = :istatus', [':istatus' => $istatus])
                 ->all()
                ;
        
        $query = Mdrugitems::find()
                ->where('check_status = :check_status', [':check_status' => $check_status])
                ->andWhere(['NOT IN',['concat(icode,tpu_code_list)'], $model])
                ;
        ...
        $query->andFilterWhere([
            ...
            'state_item_id' => $this->state_item_id,
        ]);
        ...
        $query->andFilterWhere(['like', 'icode', $this->icode])
                ...
                ->andFilterWhere(['like', 'sks_specprep', $this->sks_specprep])
                ...
                ->andFilterWhere(['like', 'dmi', $this->dmi])
                ...
                ->andFilterWhere(['like', 'no_remed', $this->no_remed])
                ->andFilterWhere(['like', 'force_round_qty', $this->force_round_qty])
                ->andFilterWhere(['like', 'atc_code', $this->atc_code]);
