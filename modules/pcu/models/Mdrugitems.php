...
/**
 * This is the model class for table "drugitems".
 *
 ...
 * @property string $no_remed
 * @property string $force_round_qty
 * @property string $atc_code
 * @property int $state_item_id
 */
class Mdrugitems extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['lastupdatestdprice', 'begin_date', 'finish_date', 'last_update','check_status','check_anti'], 'safe'],
            ...
            [['drugaccount', 'paidst', 'income', 'sks_specprep'], 'string', 'max' => 2],
    ...
    public function attributeLabels()
    {
        return [
            ...
            'no_remed' => 'No Remed',
            'force_round_qty' => 'Force Round Qty',
            'atc_code' => 'Atc Code',
            'state_item_id' => 'State Item ID',
            'check_status' => 'Check Status',
            'check_anti' => 'Check Anti',
        ];
    }
}
