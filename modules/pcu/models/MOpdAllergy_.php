...
/**
 * This is the model class for table "m_opd_allergy".
 *
 * @property string $hn
 ...
 * @property string $dosage_text
 * @property string $usage_text
 * @property string $lab_text
 */
class MOpdAllergy extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    public function rules()
    {
        return [
            ...
            [['note', 'dosage_text', 'usage_text', 'lab_text'], 'string'],
    ...
    public function attributeLabels()
    {
     ...
     public function getPatient() {
        return $this->hasOne(Patient::className(), ['cid' => 'patient_cid']);
    }
}
